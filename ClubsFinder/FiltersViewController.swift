...
class FiltersViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        self.model = ClubsFilters(instance: ClubsFilters.instance)
    }
    

    // Number of available filters = number of sections
    override func numberOfSectionsInTableView(tableView: UITableView) -> Int {
        return self.model!.filters.count
    }
    
    // Display of filters type Int
    ...
    // Display of filters with labels (String type)
    ...
    // Button APPLY
    @IBAction func handleApplyButton(sender: AnyObject) {
        // Commit the changes to the global instance of the filters
        ClubsFilters.instance.copyStateFrom(self.model!)
